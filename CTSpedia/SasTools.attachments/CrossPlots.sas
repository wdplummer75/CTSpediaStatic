...
Filename inclmm URL "http://twiki.library.ucsf.edu/twiki/pub/CTSpedia/UtilityMacros/GetVarList.sas";
%Include inclmm;
Filename inclmm URL "http://twiki.library.ucsf.edu/twiki/pub/CTSpedia/UtilityMacros/CheckData.sas";
%Include inclmm;
Filename inclmm URL "http://twiki.library.ucsf.edu/twiki/pub/CTSpedia/UtilityMacros/CheckNumVars.sas";
%Include inclmm;
Filename inclmm URL "http://twiki.library.ucsf.edu/twiki/pub/CTSpedia/UtilityMacros/CheckNumber.sas";
%Include inclmm;
Filename inclmm URL "http://twiki.library.ucsf.edu/twiki/pub/CTSpedia/UtilityMacros/CheckStr.sas";
%Include inclmm;
...
%Macro CrsPlot(pdata,v1,v2,MaxLevl);
  ...
  *Save the frequency counts in a macro variable;
  ...
  %If &_xlevl>&MaxLevl %Then %Do; *Scatterplot;
    %Put Scatterplot xlevl=&_xlevl MaxLevl=&MaxLevl;
    Symbol1 V=Plus I=None L=1 W=2 Bwidth=2 C=Black;
    Proc Gplot Data=&pdata Gout=work._mplot;
      Plot &v2*&v1 / Frame Haxis=Axis1 Vaxis=Axis2 Nolegend;
    Run;
  %End;
  %Else %Do; *Boxplot;
    %Put Boxplot xlevl=&_xlevl MaxLevl=&MaxLevl;
