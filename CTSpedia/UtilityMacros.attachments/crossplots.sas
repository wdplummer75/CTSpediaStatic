...
Filename inclmm URL "http://ctspedia.org/wiki/pub/CTSpedia/UtilityMacros/GetVarList.sas";
%Include inclmm;
...
%Include inclmm;
Filename inclmm URL "http://ctspedia.org/wiki/pub/CTSpedia/UtilityMacros/CheckStr.sas";
%Include inclmm;
