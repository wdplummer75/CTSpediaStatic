...
%include words;
filename CheckD URL "http://www.ctspedia.org/wiki/pub/CTSpedia/UtilityMacros/CheckData.sas";
%include CheckD;
filename CheckV URL "http://www.ctspedia.org/wiki/pub/CTSpedia/UtilityMacros/CheckVariabs.sas";
%include CheckV;
filename ES URL "http://www.ctspedia.org/wiki/pub/CTSpedia/EffectSizeLongitudinal/EffectSize.sas";
%include ES;
...
%if %CheckVariabs(&DSName,&Varlist,Y) %then %Do;
...
%do;
	ods rtf file = "&MacroDir.\ESMacroOutput.rtf";
