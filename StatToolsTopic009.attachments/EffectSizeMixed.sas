* EffectSizeMixed macro computes the effect sizes using a linear mixed-effect model.
...
;
%macro EffectSizeMixed(MacroDir=,
					DSName=,
					Outcome=,
					Cluster=,
					Treatment=,
...
filename words URL "https://www.ctspedia.org/wiki/pub/CTSpedia/UtilityMacros/words.sas";
%include words;
...
%do;
	ods rtf file = "&MacroDir.\EffectSizeMixedOutput.rtf";
...
%do;
	ods html file = "&MacroDir.\EffectSizeMixedOutput.htm";
